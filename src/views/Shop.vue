...
<!--         <header>
        ...
        <section>
            <!-- 검색창 -->
            <form class="search">
                <input type="search" class="input_search" name="input_search" placeholder="검색어를 입력하세요.">
                <button type="submit" class="input_submit"></button>
            </form>
...
.search .input_submit {
    ...
    background: url(../assets/shopView/shop_search_bt.png) no-repeat;
